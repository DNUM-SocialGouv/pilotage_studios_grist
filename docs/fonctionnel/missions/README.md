...
- Produits encore stub ; écran **Équipe** = `/equipe` (pas de lien croisé depuis la fiche mission)
- Contexte fiche : formatage léger (paragraphes, listes, gras `**…**`, liens Markdown http(s) — pas de HTML brut)