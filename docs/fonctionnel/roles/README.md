...
**Statut (2026-09-21)** : inventaire anonymisé · `Equipe.Role_ACL` · User Attribute `Equipe` **fait** · pont `Acl_profil` + UX nav/gardes **fait** · Access Rules **Equipe** par rôle **fait** (#55) · déclaration CRA widget V1 **fait** (`/cra/declarer`) · revue CRA équipe widget V1 **fait** (`/cra/revue-equipe`, #70) · règles `Realise` par rôle **fait** (#47 / #70).
