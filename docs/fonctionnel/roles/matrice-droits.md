...
|------|------------|---------|---------------|
| 2026-09-19 | Équipe : colonne `Avatar` (seed Pixelbot) + affichage liste/fiche ; CSP `img-src` DiceBear ; pas d’écriture widget ni changement ACL Freelance | 5 | Avatars Pixelbot |
