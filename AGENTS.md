...
5. Avant merge : skill [`pilotage-grist-code-review`](.cursor/skills/pilotage-grist-code-review/SKILL.md) ; proposer passage **Livré** via skill kanban si sujet produit.
